...
import avatar from "@/public/moi.jpg";
    ...
    <section ref={ref} id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        <div className="flex items-center justify-center">
            <div className="relative">
                ...
                >
                    <Image
                     src={avatar} alt="Avatar Arthur" width="192" height="192" quality = "95" priority={true}
                    className="h-24 w-24 rounded-full pbject-cover border-[0.35rem] border-white shadow-xl"
                    />
                </motion.div>
        ...
        >
        <span className="font-bold">Bonjour, je suis Arthur.</span> Je suis {" "}
        <span className="font-bold">Apprenti Développeur</span> mon objectif est de créer des 
        <span className="italic">sites & des apps</span>. Je me spécialise sur{" "}
        ...
        >
            <Link href="mailto:arthur29javourez@hotmail.com" className="group bg-gray-900 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none  hover:scale-110 hover:bg-gray-950 
            ...
            <a className="bg-white text-gray-700 p-4 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10" href="https://github.com/arthurjvz" target="_blank"> <FaGithub/></a>
        </motion.div>
    </section>
  )
}
